/*
  ...
  2. Security
    ...
    - Participants can only access their rooms
    - Messages restricted to room participants
...
-- Users can read reactions in their rooms
...
-- Users can read typing indicators in their rooms
